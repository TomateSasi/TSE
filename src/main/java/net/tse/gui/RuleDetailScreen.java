...
public class RuleDetailScreen extends Screen {
    ...
    protected void init() {
        ...
        widget(FlatButton.builder(Component.literal("Color"), btn ->
                        Minecraft.getInstance().setScreen(new ColorPickerScreen(this, rule.overlayColor,
        ...
        widget(FlatButton.builder(Component.literal("Color"), btn ->
                        Minecraft.getInstance().setScreen(new ColorPickerScreen(this, rule.closeWarnColor,
